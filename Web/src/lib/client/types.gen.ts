...
export type NullableOfRoleInfo3 = {
    id?: number;
    name?: string;
} | null;
...
export type GetActiveGameIdData = {
    body?: never;
    path?: never;
    query?: never;
...
export type GetActiveGameIdErrors = {
    /**
     * Not Found
     */
    404: ProblemDetails;
...
export type GetActiveGameIdError = GetActiveGameIdErrors[keyof GetActiveGameIdErrors];

export type GetActiveGameIdResponses = {
    /**
     * OK
     */
    200: number;
...
export type GetActiveGameIdResponse = GetActiveGameIdResponses[keyof GetActiveGameIdResponses];
...
export type GetPlayerByNameData = {
    body?: never;
    path: {
        name: string;
        gameId: number;
...
export type GetPlayerByNameErrors = {
    /**
     * Not Found
     */
    404: ProblemDetails;
...
export type GetPlayerByNameError = GetPlayerByNameErrors[keyof GetPlayerByNameErrors];

export type GetPlayerByNameResponses = {
    /**
     * OK
     */
...
export type GetPlayerByNameResponse = GetPlayerByNameResponses[keyof GetPlayerByNameResponses];
